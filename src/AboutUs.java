...
public class AboutUs
{
  ...
  Credentials cred;
	...
	public AboutUs(Credentials cred) {

    this.cred = cred;
            //adding panels,  frames and components

             jf = new JFrame("ABOUT US");
             head = new JPanel();
             mainmenu = new JPanel();
             content = new JPanel();
             info = new JPanel();
            ...
            // contents changes
            heading.setBounds(25, 20, 500, 40);
            heading.setForeground(new Color(0xFFFFFF));
            heading.setFont(new Font("Times New Roman", Font.BOLD, 22));


            tf.setText("OUR MISSION - Seeking to engage all Mahindra alumni in a mutually beneficial, lifelong connection to each other, their school, and the University, and encourage alumni support and guidance to advance Mahindra's eminence for future generations. \n\n OUR PURPOSE- To Train Multi-skilled leaders capable of reflection as well as innovation, committed to inclusive and sustainable progress; Aim for interdisciplinary academic excellence integrating the study of science and technology with humanities, ethics and philosophy. and design; Balance education with experience through entrepreneurial projects to solve complex challenges facing society\n\n The first and foremost step to forming our community is taken by the students. Come out and commemorate your college life with the opportunity to reminisce and celebrate.");
            tf.setLineWrap(true);
            tf.setBounds(25, 80, 400, 510);
            ...
            content.setBounds(680,130, 450 ,600);
...
// background image
            ...
            ImageIcon bg = new ImageIcon("images/about.png");
